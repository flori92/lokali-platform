...
echo "🌐 URL de production: https://flori92.github.io/stay-local-rent-easy/"
echo ""
...
echo ""
echo "🔗 Liens utiles:"
echo "   - Actions: https://github.com/flori92/stay-local-rent-easy/actions"
echo "   - Site: https://flori92.github.io/stay-local-rent-easy/"
